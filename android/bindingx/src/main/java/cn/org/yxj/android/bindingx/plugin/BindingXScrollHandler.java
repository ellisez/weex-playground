...
import cn.org.yxj.android.bindingx.core.internal.AbstractScrollEventHandler;
    ...
    private class InnerListScrollListener extends RecyclerView.OnScrollListener{
        ...
        public void onScrolled(RecyclerView recyclerView, final int dx, final int dy) {
            ...
            if(ViewCompat.isInLayout(recyclerView) && mComponentRef != null && mComponentRef.get() != null) {
                WXListComponent component = mComponentRef.get();
                int offset = 0;
                if(component.getChild(0) != null && component.getChild(0) instanceof WXRefresh) {
                    offset = (int) component.getChild(0).getLayoutHeight();
                }
                mContentOffsetY = Math.abs(component.calcContentOffset(recyclerView)) - offset;
            } else {
                mContentOffsetY += dy;
            }
            mContentOffsetX += dx;
