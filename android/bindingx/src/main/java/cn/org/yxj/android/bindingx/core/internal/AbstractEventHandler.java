...
import cn.org.yxj.android.bindingx.core.BindingXJSFunctionRegister;
import cn.org.yxj.android.bindingx.core.BindingXPropertyInterceptor;
import cn.org.yxj.android.bindingx.core.IEventHandler;
...
public abstract class AbstractEventHandler implements IEventHandler {
    ...
    @Override
    public void setOriginalParams(Map<String, Object> params) {
        if(params == null || params.isEmpty()) {
            mOriginParams = Collections.emptyMap();
        } else {
            mOriginParams = Collections.unmodifiableMap(params);
        }
    }
