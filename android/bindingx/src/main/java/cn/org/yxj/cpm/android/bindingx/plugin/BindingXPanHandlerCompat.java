 ...
 * Description:
 *
 * a compatible version of pan handler which use weex's new interface to inject touch listener.
 *
...
public class BindingXPanHandlerCompat extends BindingXTouchHandler{
    ...
    public BindingXPanHandlerCompat(Context context, PlatformManager manager, Object... extension) {
    ...
    public boolean onCreate(@NonNull String sourceRef, @NonNull String eventType) {
        ...
        try {
            ...
            if(mWeexGestureHandler != null) {
                ...
                LogProxy.d("[BindingXPanHandlerCompat] onCreate success. {source:" + sourceRef + ",type:" + eventType + "}");
                return true;
            } else {
                return super.onCreate(sourceRef, eventType);
            }
