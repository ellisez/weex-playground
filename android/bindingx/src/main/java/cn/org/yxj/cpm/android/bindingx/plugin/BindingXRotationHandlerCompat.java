 ...
 * Description:
 *
 * a compatible version of rotation handler which use weex's new interface to inject touch listener.
 *
...
public class BindingXRotationHandlerCompat extends BindingXRotationHandler {
    ...
    public BindingXRotationHandlerCompat(Context context, PlatformManager manager, Object... extension) {
    ...
    public boolean onCreate(@NonNull String sourceRef, @NonNull String eventType) {
        ...
        try {
            ...
            if(mWeexGestureHandler != null) {
                ...
                LogProxy.d("[BindingXRotationHandlerCompat] onCreate success. {source:" + sourceRef + ",type:" + eventType + "}");
                return true;
            } else {
                return super.onCreate(sourceRef, eventType);
            }
    ...
    public boolean onDisable(@NonNull String sourceRef, @NonNull String eventType) {
        ...
        if(mWeexGestureHandler != null) {
            try {
                ...
                LogProxy.e("[BindingXRotationHandlerCompat]  disabled failed." + e.getMessage());
            }
        }
        return result;
    }
