...
import cn.org.yxj.android.bindingx.core.internal.BindingXConstants;
import cn.org.yxj.android.bindingx.core.internal.BindingXOrientationHandler;
import cn.org.yxj.android.bindingx.core.internal.BindingXPinchHandler;
import cn.org.yxj.android.bindingx.core.internal.BindingXRotationHandler;
import cn.org.yxj.android.bindingx.core.internal.BindingXSpringHandler;
import cn.org.yxj.android.bindingx.core.internal.BindingXTimingHandler;
import cn.org.yxj.android.bindingx.core.internal.BindingXTouchHandler;
import cn.org.yxj.android.bindingx.core.internal.ExpressionPair;
import cn.org.yxj.android.bindingx.core.internal.Utils;
...
public class BindingXCore {
    ...
    public BindingXCore(@NonNull PlatformManager platformManager) {
        ...
        registerEventHandler(BindingXEventType.TYPE_PINCH, new ObjectCreator<IEventHandler, Context, PlatformManager>() {
            @Override
            public IEventHandler createWith(@NonNull Context context, @NonNull PlatformManager manager, Object... extension) {
                return new BindingXPinchHandler(context, manager, extension);
            }
        });
        registerEventHandler(BindingXEventType.TYPE_ROTATION, new ObjectCreator<IEventHandler, Context, PlatformManager>() {
            @Override
            public IEventHandler createWith(@NonNull Context context, @NonNull PlatformManager manager, Object... extension) {
                return new BindingXRotationHandler(context, manager, extension);
            }
        });
        ...
        registerEventHandler(BindingXEventType.TYPE_SPRING, new ObjectCreator<IEventHandler, Context, PlatformManager>() {
            @Override
            public IEventHandler createWith(@NonNull Context context, @NonNull PlatformManager manager, Object... extension) {
                return new BindingXSpringHandler(context, manager, extension);
            }
        });
    }
    ...
    public String doBind(@Nullable Context context,
        ...
        return doBind(anchor, anchorInstanceId, eventType, configMap, exitExpressionPair, expressionArgs, interceptors, callback, context, instanceId, params, extension);
    }
    ...
    public String doPrepare(@Nullable Context context,
        ...
        if (handlerMap != null && (targetHandler = handlerMap.get(eventType)) != null) {/*event handler exists*/
            ...
            targetHandler.setExtensionParams(extension);
    ...
    public String doBind(@Nullable String anchor,
        ...
        if (handler == null) {
            ...
            token = doPrepare(context, instanceId, anchor, anchorInstanceId, eventType, globalConfig, params, extension);
        ...
        if (handler != null) {
            handler.setOriginalParams(params);
